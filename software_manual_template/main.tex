...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% START OF AuScope MANUAL COVER TEMPLATE %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\\[12pt]
{\Large LaTeX Template for AuScope Software User Manuals}
\end{center}
...
{\noindent
{\href{https://www.auscope.org.au}{www.auscope.org.au}}
}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%   END OF AuScope MANUAL COVER TEMPLATE    %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
This document provides some guidelines on how to write a software manual for AuScope community codes. This includes advice on what content to include and how to format the document using LaTeX. The exact section headings, numbering, and order of presentation may depend on the specific software package. 
...
\note{See also \url{**FIX** https://www.auscope.org.au/abc} for more information on how to cite software.}

\subsection{Support} 
Acknowledge sources of support including grants, fellowships, etc.
In particular, please acknowledge AuScope as follows:
{\parindent0pt
  \begin{center}
    \shadowbox{
      \begin{minipage}[c]{0.9\linewidth}
\textsc{softwareName} is hosted by AuScope
