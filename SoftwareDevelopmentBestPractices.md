...
> A [standalone version of this table](SoftwareDevelopmentBestPracticesTable.md) is also available.

| Category | Minimum | Standard | Target |
| --- | --- | --- | --- |
